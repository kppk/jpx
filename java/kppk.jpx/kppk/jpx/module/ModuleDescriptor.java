...
import static kppk.jpx.module.Checks.requireModuleName;
import static kppk.jpx.module.Checks.requirePackageName;
import static kppk.jpx.module.Checks.requireQualifiedClassName;
import static kppk.jpx.module.Checks.requireServiceTypeName;
...
public class ModuleDescriptor
    ...
    public final static class Exports
        ...
        private Exports(Set<Modifier> ms, String source, Set<String> targets) {
            this.mods = Sets.copyOf(ms);
            this.source = source;
            this.targets = Sets.copyOf(targets);
        }
    ...
    private ModuleDescriptor(String name,
        ...
        this.modifiers = Sets.copyOf(modifiers);
        ...
        assert (requires.stream().map(Requires::name).distinct().count()
                == requires.size());
        this.requires = Sets.copyOf(requires);
        this.exports = Sets.copyOf(exports);
        this.opens = Sets.copyOf(opens);
        this.uses = Sets.copyOf(uses);
        this.provides = Sets.copyOf(provides);

        this.packages = Sets.copyOf(packages);
    ...
    public static final class Builder {
         ...
         * @return This builder
         * @throws IllegalArgumentException If the dependence is on the module that this builder was
         *                                  initialized to build
         * @throws IllegalStateException    If the dependence on the module has already been declared
         ...
         * @return This builder
         * @throws IllegalArgumentException If the module name is {@code null}, is not a legal module
         ...
         * @param e The export
         * @return This builder
         * @throws IllegalStateException If the {@link Exports#source() package} is already declared as
         ...
         * @return This builder
         * @throws IllegalArgumentException If the package name is {@code null} or is not a legal
         *                                  package name, the set of target modules is empty, or the set
         *                                  of target modules contains a name that is not a legal module
         *                                  name
         * @throws IllegalStateException    If the package is already declared as exported
         *                                  or this builder is for an automatic module
         */
         ...
         * @return This builder
         * @throws IllegalStateException If the package is already declared as open, or this is a
         ...
         * @return This builder
         * @throws IllegalArgumentException If the service type is {@code null} or not a qualified name of
         *                                  a class in a named package
         * @throws IllegalStateException    If a dependency on the service type has already been declared
         ...
         * @return This builder
         * @throws IllegalStateException If the providers for the service type have already been
         *                               declared
         */
         ...
         * @return This builder
         * @throws IllegalArgumentException If the service type or any of the provider class names is
         ...
         * @return This builder
         * @throws IllegalArgumentException If any of the package names is {@code null} or is not a
         *                                  legal package name
         */
         ...
         * @return This builder
         * @throws IllegalArgumentException If {@code vs} is {@code null} or cannot be parsed as a
         *                                  version string
         ...
         * @return This builder
         * @throws IllegalArgumentException If {@code mainClass} is {@code null} or not a qualified
        ...
        public ModuleDescriptor build() {
            ...
            if (strict
                ...
                requires.add(new Requires(Sets.of(Requires.Modifier.MANDATED),
                        "java.base",
                        null,
                        null));
            }
    ...
    public static Builder newOpenModule(String name) {
        return new Builder(name, true, Sets.of(Modifier.OPEN));
    }
    ...
    public static Builder newAutomaticModule(String name) {
        return new Builder(name, true, Sets.of(Modifier.AUTOMATIC));
    }
    ...
    int compare(Set<T> s1, Set<T> s2) {
        ...
        Arrays.sort(a1);
        Arrays.sort(a2);
        return ArraysUtil.compare(a1, a2);
    }
