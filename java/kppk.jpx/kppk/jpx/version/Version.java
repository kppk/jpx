...
public final class Version implements Comparable<Version> {
     ...
     */
    public Version(Class<?> clazz) throws ParseException {
     ...
     * @return true if the tag is found in {@link Version#buildMeta}.
     */
     ...
     *
     * @param tag the tag to check for
     * @return true if the tag is found in {@link Version#preRelase}.
     */
     ...
     */
    public boolean isUpdateFor(Version v) {
     ...
     */
    public boolean isCompatibleUpdateFor(Version v) {
    ...
    private int comparePreReleaseTag(int pos, Version ov) {
        Integer here = null;
        Integer there = null;
        try {
